...
class GetBaseScoreServiceTest extends TestCase
{
    /**
     * @param Tender $tender
    ...
    public function testGet(
        ...
        $getBaseScoreService = new GetBaseScoreService($getMandatoryGraduationResultService, $getBestOptionalGraduationResultService);
        $result = $getBaseScoreService->get($tender, $study);
    ...
    public static function providerForTestGet(): array
    {
        return [
            [
                ...
                'expected' => new UnsignedInteger(370),
            ],
        ];
    }
}
