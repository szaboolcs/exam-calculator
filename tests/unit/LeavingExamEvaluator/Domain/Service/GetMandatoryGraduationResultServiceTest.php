...
class GetMandatoryGraduationResultServiceTest extends TestCase
{
    /**
     * @param Tender $tender
    ...
    public function testGet(
        ...
        $graduationResult                    = $getMandatoryGraduationResultService->get($tender, $study);

        $this->assertEquals($mandatoryGraduationResult, $graduationResult);
    }
